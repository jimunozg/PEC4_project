...
Ejecuta el archivo `main.py` desde el directorio raíz del proyecto para comenzar la interacción:
```bash
python PEC4/main.py
```
...
Asegúrate de que las dependencias estén instaladas. Esto se puede hacer utilizando el archivo `setup_tests.py` con el siguiente comando:
```bash
pip install test/
```
